(function (window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        init: function () {
            ...
            axilInit._window.on('resize', function () {
                self.mobileMenuNavShow();
            });
        },
        ...
        mobileMenuNavShow: function () {
            var screenWidth = axilInit._window.width();
            if (screenWidth < 1200) {
                $('.popup-mobilemenu-area .menu-item-has-children a').off('click').on('click', function (e) {
                    e.preventDefault();
                    $(this).siblings('.axil-submenu').slideToggle('400');
                    $(this).toggleClass('open').siblings('.axil-submenu').toggleClass('active');
                ...
                $('.popup-mobilemenu-area .menu-item-has-children a').off('click');
            }
        },
